                    ...
                    <form  method="GET">
                        <div class="form-group">
                            <label for="exampleInputEmail1">
                                Enter the Purchase Code shared by the customer for eCart</label>
                            <input type="text" class="form-control" 
                            id="purchase_code" name="purchase_code" 
                            placeholder="Enter the purchase code here" required>
                        </div>
                        <!-- /.box-body -->
                        <div class="box-footer">
                            <button type="submit" class="btn btn-primary" name="btnValidate" 
                            id="btnValidate">Validate Now</button>
