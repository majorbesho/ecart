...
define('DOMAIN_URL', 'http://127.0.0.1/'); /* chnage to your domain here - don't forget to add forward slash at the end of the URL like this "/" */
define('ALLOW_MODIFICATION', 1);
 define('JWT_SECRET_KEY', '2FA7576619551509B35715E7A7E58460B1E40FDECEA2A8DA2515574E88D868AE
 '); /* chnage to your secret key here set it to anything you like*/
...
class Database
{
    ...
    private $db_pass = "123";  // Change as required
    private $db_name = "newcart";    // Change as required
